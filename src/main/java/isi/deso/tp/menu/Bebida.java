...
public class Bebida extends ItemMenu {
    ...
    public Bebida(String nombre, String descripcion, Double precio, boolean aptoVegano, Double peso, Double volumen, Double graduacionAlcohol, Integer vendedorId) {
