...
public class CargarItemMenuVista extends javax.swing.JFrame {
    ...
    public void llenarTabla() {
        ...
        ItemMenuController.getInstance().listarItemsMenu().forEach(im -> {
        ...
        tablaItemMenu.setModel(Modelotabla);

        TableRowSorter<DefaultTableModel> sorter = new TableRowSorter<>(Modelotabla);
        tablaItemMenu.setRowSorter(sorter);
    ...
    private void initComponents() {
        ...
        tablaItemMenu = new javax.swing.JTable();
        ...
        tablaItemMenu.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tablaItemMenu);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if (tablaItemMenu.getSelectedRowCount() > 0) {
            try {
                ...
                int[] filasSeleccionadas = tablaItemMenu.getSelectedRows();

                for (int fila : filasSeleccionadas) {

                    Object idObj = tablaItemMenu.getValueAt(fila, 0);
                    String itemMenuId = idObj.toString();

                    Object nombreObj = tablaItemMenu.getValueAt(fila, 1);
                    String itemMenuNombre = nombreObj.toString();

                    Object precioObj = tablaItemMenu.getValueAt(fila, 2);
    ...
    private javax.swing.JTable tablaItemMenu;
