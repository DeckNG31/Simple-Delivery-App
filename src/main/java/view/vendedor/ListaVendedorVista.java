...
public class ListaVendedorVista extends javax.swing.JFrame {
    ...
    public void llenarTabla() {
        ...
        String titulos[] = {"ID", "Nombre", "Direccion", "Coordenadas"};
    ...
    private void initComponents() {
        ...
        tablaVendedores.setAlignmentX(1.0F);
        tablaVendedores.setAlignmentY(1.0F);
        ...
        if (tablaVendedores.getColumnModel().getColumnCount() > 0) {
            ...
            tablaVendedores.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    public void buscar() {
        ...
        TableRowSorter<DefaultTableModel> sorter = (TableRowSorter<DefaultTableModel>) tablaVendedores.getRowSorter();
