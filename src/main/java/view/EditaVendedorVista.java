 ...
 * @author mariano
 */
public class EditaVendedorVista extends javax.swing.JFrame {
     ...
     */
    public EditaVendedorVista() {
        initComponents();
    }

    public EditaVendedorVista(Integer id) {
        vendedorId = id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditaVendedorVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditaVendedorVista().setVisible(true);
            }
        });
    }
